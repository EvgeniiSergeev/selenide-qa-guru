...
public class Snippets {
    ...
    void browser_command_examples() {
        ...
        Selenide.clearBrowserCookies(); // clear кэш
        ...
        WebDriverRunner.getWebDriver().manage().addCookie(cookie); // добавляем , дальше нужен рефреш
    ...
    void selectors_examples() {
        $("div").click();
        element("div").click(); // для котлин

        $("div", 2).click(); // поиск по дивам the third div

        $x("//h1/div").click(); // использование xpath
    ...
    void actions_examples() {
        ...
        $("").hover(); // подвести мышь но не наживать

        $("").setValue("text"); // запись текст в полн
    ...
    void conditions_examples() {
        ...
        $("").should(matchText("[0-9]abc$")); // проверка на правильность ввожа к примеру почты
        ...
        $("").should(exist); // гналиче элемента в доме, видимых и нет
    ...
    void collections_examples() {
        ...
        $$("div"); // does nothing! команда ищет все дивы, поиск начинается после ассерта
